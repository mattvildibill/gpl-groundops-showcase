...
public class EventPublisher {
  ...
  public void publishPlanApproved(PlanApprovedEvent event, String correlationId, String actor) {
    validate(event);
    send(EventDestinations.PLAN_APPROVED, event, correlationId, actor);
  }
